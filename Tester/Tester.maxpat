...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.5, 263.0, 193.0, 18.0 ],
					"presentation_rect" : [ 311.0, 262.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "open" ],
					"patching_rect" : [ 315.5, 292.0, 44.0, 20.0 ],
					"presentation_rect" : [ 311.0, 291.0, 0.0, 0.0 ],
					"text" : "t open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.5, 331.0, 53.0, 20.0 ],
					"presentation_rect" : [ 311.0, 330.0, 0.0, 0.0 ],
					"text" : "pcontrol"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 72.5, 100.0, 107.0, 22.0 ],
									"text" : "EnsembleFive"
								}
...
,
					"patching_rect" : [ 315.5, 366.0, 195.0, 20.0 ],
					"presentation_rect" : [ 311.0, 365.0, 0.0, 0.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 263.0, 199.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "open" ],
					"patching_rect" : [ 23.0, 292.0, 44.0, 20.0 ],
					"text" : "t open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 331.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
,
									"patching_rect" : [ 520.0, 240.0, 92.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
,
									"patching_rect" : [ 520.0, 171.0, 92.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 23.0, 366.0, 201.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
